...
public class GodTest {
    ...
    public void testGodMoves() {
        ...
        chessBoard.placePiece(new God(Piece.Color.WHITE), ChessBoard.ROW._1, ChessBoard.COLUMN.F);
    ...
    public void testGodWhenOnlyFriendlyOnBoard() {
        ChessBoard chessBoard = ChessBoardFactory.emptyBoard();
        chessBoard.placePiece(new God(Piece.Color.WHITE), ChessBoard.ROW._1, ChessBoard.COLUMN.F);
        chessBoard.placePiece(new God(Piece.Color.WHITE), ChessBoard.ROW._4, ChessBoard.COLUMN.F);

        assertEquals("God can move ANYWHERE BUT IS SO SUBLIME DOES NOT CAPTURE IT'S OWN",
                62, chessBoard.moveSet(ChessBoard.ROW._1, ChessBoard.COLUMN.F).size());
    }
    ...
    public void testGodWhenOnlyEnemyOnBoard() {
        ChessBoard chessBoard = ChessBoardFactory.emptyBoard();
        chessBoard.placePiece(new God(Piece.Color.WHITE), ChessBoard.ROW._1, ChessBoard.COLUMN.F);
        chessBoard.placePiece(new God(Piece.Color.BLACK), ChessBoard.ROW._4, ChessBoard.COLUMN.F);

        assertEquals("God can move ANYWHERE AND CAPTURES ENEMIES UNMERCIFULLY",
                63, chessBoard.moveSet(ChessBoard.ROW._1, ChessBoard.COLUMN.F).size());
    }
}
