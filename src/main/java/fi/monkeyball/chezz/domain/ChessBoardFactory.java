...
public class ChessBoardFactory {
    ...
    public static ChessBoard gameStart() {
        ...
        chessBoard.placePiece(new Rook(Piece.Color.WHITE), ChessBoard.ROW._1, ChessBoard.COLUMN.A);
        ...
        chessBoard.placePiece(new Rook(Piece.Color.WHITE), ChessBoard.ROW._1, ChessBoard.COLUMN.H);
        ...
        chessBoard.placePiece(new Rook(Piece.Color.BLACK), ChessBoard.ROW._8, ChessBoard.COLUMN.A);
        ...
        chessBoard.placePiece(new Rook(Piece.Color.BLACK), ChessBoard.ROW._8, ChessBoard.COLUMN.H);
